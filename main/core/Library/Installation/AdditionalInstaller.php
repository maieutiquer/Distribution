...
class AdditionalInstaller extends BaseInstaller implements ContainerAwareInterface
{
    ...
    public function preUpdate($currentVersion, $targetVersion)
    {
        ...
        if (version_compare($currentVersion, '12.5.49', '<')) {
            $updater = new Updater\Updater120549($this->container, $this->logger);
    ...
    public function postUpdate($currentVersion, $targetVersion)
    {
        ...
        if (version_compare($currentVersion, '12.5.43', '<')) {
            $updater = new Updater\Updater120543($this->container, $this->logger);
        ...
        if (version_compare($currentVersion, '12.5.47', '<')) {
            $updater = new Updater\Updater120547($this->container, $this->logger);
