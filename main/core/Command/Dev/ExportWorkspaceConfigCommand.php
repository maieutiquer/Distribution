...
class ExportWorkspaceConfigCommand extends ContainerAwareCommand implements AdminCliCommand
{
    protected function configure()
    {
        $this->setName('claroline:workspace:config-export')
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $data = $container->get('claroline.manager.workspace.transfer')->export($workspace, true);
